...
weight: 1
image: "img/error.png"
description: "Lack attention is a threat to unbiased estimates through list experiments. By modeling the error process, we show that different control list designs are associated with different kinds of bias and provide concrete guidance on designs that minimize the risk of type 1 errors"
output:
  blogdown::html_page:
    toc: false
---
...
[**Open-access at Research & Politics**](https://journals.sagepub.com/doi/full/10.1177/20531680211013154)
