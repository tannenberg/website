...
weight: 10
image: "img/eba.png"
description: "Written together with Bo Rothstein, this commissioned report aims to summarize the results of research from the Quality of Government approach in terms of its importance for development and aid policy."
output:
  blogdown::html_page:
    toc: false
---

[**The Expert Group for Aid Studies (EBA) Report**](https://eba.se/), 2015:07.

[**PDF**](https://eba.se/wp-content/uploads/2015/12/Making_development_work_07.pdf); [**Presentation at Rosenbad**](https://eba.se/eba-radio/part-i-time-to-reconsider-the-development-agenda-and-to-focus-on-the-enemy-number-one/)
